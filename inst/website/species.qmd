...
recent_base |>
  ...
  pivot_wider(names_from = "when", values_from = "classification") -> classif
trend |>
  select(-"url") |>
  kable(align = "lccc") |>
  ...
  column_spec(
    2, color = "white",
    background = effectclass:::detailed_signed_palette[classif[[2]]]
  ) |>
  column_spec(
    3, color = "white",
    background = effectclass:::detailed_signed_palette[classif[[3]]]
  ) |>
  column_spec(
    4, color = "white",
    background = effectclass:::detailed_signed_palette[classif[[4]]]
  )
```
